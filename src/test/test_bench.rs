...
pub fn test_double_chain_flood(){
    ...
    let neighbour_d10 = HashMap::from([(9, d9_flood_sender.clone()), (5, d5_flood_sender.clone())]);
...
pub fn test_star_flood(){
    ...
    let neighbour_d2 = HashMap::from([(5, d5_flood_sender.clone()), (8, d8_flood_sender.clone())]);
